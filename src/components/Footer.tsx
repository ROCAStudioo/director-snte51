...
import { siteConfig, navItems } from '@/data/site-data';

const socialLinks = [
  { name: 'Facebook', href: siteConfig.social.facebook, icon: () => (
  ...
  { name: 'Instagram', href: siteConfig.social.instagram, icon: () => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-white font-bold leading-tight">Fondo de Ahorro</p>
                <p className="text-gray-400 text-xs">SNTE Sección 51 · Puebla</p>
              </div>
            </div>
            
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-sm">
              Administrando con transparencia y compromiso el patrimonio de las y los trabajadores de la educación del estado de Puebla.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-400 text-sm">{siteConfig.contact.address}</p>
              </div>
            ...
            <ul className="space-y-2.5">
              {navItems.map(item => (
                <li key={item.href}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-orange-500/0 group-hover:bg-orange-500 transition-all duration-200"/>
                    {item.label}
                  </button>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-2 mb-6">
              {socialLinks.map(social => (
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-gray-800 hover:bg-orange-500 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-200"
                >
                  <social.icon/>
                </a>
              ))}
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-gray-400 hover:text-orange-400 text-sm transition-colors flex items-center gap-1.5">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs text-center sm:text-left">
            © 2026 Fondo de Ahorro para las y los Trabajadores de la Educación · Sección 51 SNTE · Todos los derechos reservados
          </p>
          
          <div className="flex items-center gap-4">
            <p className="text-gray-600 text-xs">Desarrollado con ❤️ para el Magisterio Poblano</p>
            <button
              onClick={scrollToTop}
              className="w-8 h-8 rounded-lg gradient-orange flex items-center justify-center shadow-md hover:shadow-lg hover:scale-110 transition-all duration-200"
